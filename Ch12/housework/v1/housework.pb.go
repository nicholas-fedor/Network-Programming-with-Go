// Pages 281-282
// Listing 12-17: Protocol buffer definition for your housework application
...
var file_housework_v1_housework_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x65, 0x73, 0x42, 0x1d, 0x5a, 0x1b, 0x43, 0x68, 0x31, 0x32, 0x2f, 0x68, 0x6f, 0x75,
...
func file_housework_v1_housework_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_housework_v1_housework_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Chore); i {
			case 0:
				return &v.state
			case 1:
		...
		file_housework_v1_housework_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Chores); i {
			case 0:
				return &v.state
			case 1:
