// Pages 96-97
// Listing 4-21: The command line flags for the ping command.
// This is a small application that reports th etime it takes to establish a TCP
// connection with a host on a specific port.
package main
...
// Listing 4-22: Reporting the time to establish a TCP socket to a given host
// and port.
func main() {
	flag.Parse()
